...
import com.example.barangkushopserver.Object.Order;
...
class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyViewHolder(@NonNull View itemView) {
        super(itemView);
        name = itemView.findViewById(R.id.product_name_det);
        quantity = itemView.findViewById(R.id.product_quantity_det);
        price = itemView.findViewById(R.id.product_price_det);
